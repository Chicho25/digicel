...
<section class="panel panel-default">
    <header class="panel-heading">
      <span class="h4">Notas &amp; Adjuntos</span>
      <span><a href="modal-notes.php" data-toggle="ajaxModal" class="btn btn-sm btn-primary">Agregar</a></span>
    </header>
			          ...
			          <div class="col-sm-6">
				          <a href="modal-notes.php?id=<?php echo $value['id']?>" data-toggle="ajaxModal" >
				            <span class="clear">
				              ...
				              <small class="padder text-muted clear text-ellipsis p"><?php echo date("Y-m-d H:i:s", strtotime($value['create_date']))?></small>
				            </span>
				          </a>
				      </div>
				      <div class="col-sm-6">
