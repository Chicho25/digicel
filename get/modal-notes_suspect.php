	      ...
	      <div class="row">
		      <div class="form form-horizontal">
			      ...
			      <div class="form-group required">
			        ...
			        <div class="col-lg-7">
			          <select class="form-control" name="notetype" required="required" disabled >
	                       <option value="">------------------</option>
	                        <?PHP
	                        $arrKindMeetings = GetRecords("Select * from type_note WHERE stat = 1 and Name_type_note <> 'Log'");
	                        foreach ($arrKindMeetings as $key => $value) {
                            if($value['id']==6 || $value['id']==5 || $value['id']==2){ continue; }
	                          $kinId = $value['id'];
			      ...
			      <div class="form-group required">
			        ...
			        <div class="col-lg-7">
			          <input type="text" class="form-control" readonly name="subject" value="<?php echo utf8_encode($note_subject)?>"  required="required" placeholder="Asunto">
			        </div>
			      </div>
			      <?php if(!$iscall) : ?>
			      <div class="form-group">
			          ...
			          <div class="col-lg-7">
		                <input type="file" name="attached" readonly class="form-control">
		              </div>
			      </div>
			      <?php endif; ?>
			      <div class="form-group required">
			        ...
			        <div class="col-lg-7">
			          <textarea rows="7" cols="40" class="form-control" name="note" readonly required="required" placeholder="Nota"><?php echo utf8_encode($note)?></textarea>
