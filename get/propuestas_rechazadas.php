            ...
            <section class="scrollable padder">
              <section class="panel panel-default">
                <header class="panel-heading">
                          <span class="h4">Lista de Propuestas Rechazadas</span>
                </header>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped b-t b-light" data-ride="datatables">
                          ...
                          <tr>
                              ...
                              <td class="tbdata"> <a href="opportunity-view.php?id=<?php echo $value['id_oportunidad']?>" title="Ver detalle de: <?php echo $value['oportunidad']?>" class="btn btn-sm btn-icon btn-info"><i class="fa fa-edit"></i></a></td>
                          </tr>
                          <?php
                            $i++;
                          }
